...
class UserRegistrationApiView(APIView):
    ...
    def post(self,request):
        ...
        if serializer.is_valid():
            ...
            confirm_link = f"https://social-onrender-backend-2.onrender.com/user/active/{uid}/{token}"
            print(confirm_link)
...
def activate(request ,uid64,token):
    ...
    if user is not None and default_token_generator.check_token(user,token):
        ...
        return redirect('https://frontofsocial.vercel.app/login.html')
    else:
        # return redirect('https://dashing-smakager-3e3523.netlify.app/signup.html') 
        return redirect('https://frontofsocial.vercel.app/signup.html')
